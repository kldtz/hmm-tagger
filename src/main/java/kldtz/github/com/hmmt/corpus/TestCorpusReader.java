...
public abstract class TestCorpusReader implements Iterable<Sentence> {
	static final Logger logger = LoggerFactory.getLogger(TestCorpusReader.class);
	...
	public TestCorpusReader(File corpusFile) {
